...
@section('content')
<div class="flex flex-row mt-4 space-x-6 text-gray-600">
    <div class="basis-2/3 flex-col ">
        <div class="flex justify-between items-center bg-gray-100 rounded-2xl p-6 mb-6">
            <div class="flex">
                <img class="object-cover h-20 w-20 rounded-lg shadow-xl mr-4" src="res/img/user-default.png" alt="">
                <div>
            ...
            <div class="justify-self-end">
                <button class="btn btn-sm btn-primary rounded-lg normal-case text-white shadow-lg">Edit Profil</button>
            </div>
    ...
    <div class="basis-1/3 flex-col">
        <div class="flex flex-col w-full space-y-4 mb-6">
            <div class="bg-orange-400 rounded-2xl shadow-lg px-4 py-2 bg-no-repeat bg-right-bottom text-white" style="background-image: url(res/img/bg-level.svg);">
                <p class="font-semibold ">Level</p>
                <p class="font-semibold text-2xl">{{ $achievement->level }}</p>
            </div>
            <div class="bg-orange-400 rounded-2xl shadow-lg px-4 py-2 bg-no-repeat bg-right-bottom text-white" style="background-image: url(res/img/bg-xp.svg);">
                <p class="font-semibold ">Experience</p>
                <p class="font-semibold text-2xl">{{ $achievement->total_xp }}</p>
            </div>
            <div class="bg-orange-400 rounded-2xl shadow-lg px-4 py-2 bg-no-repeat bg-right-bottom text-white" style="background-image: url(res/img/bg-point.svg);">

        ...
        <div class="flex-col basis-2/4">
            ...
            <div class="flex bg-white">
                <div class="basis-2/3 flex-col p-12">
                    ...
                    <form class="form-control w-full max-w-xs" action="/masuk" method="POST">
                        @csrf
                ...
                <div class="basis-1/3 bg-base-100 bg-no-repeat bg-cover bg-right-top" style="background-image: url(/res/img/bg-masuk.png);"></div>
            </div>
        </div>
    </div>
</body>

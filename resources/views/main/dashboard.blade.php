...
<div class="grid grid-cols-3 gap-5 mt-4">
    <div class="col-span-2 bg-gray-100 p-6 rounded-3xl ">
    ...
    <div class="bg-gray-100 p-6 rounded-3xl">
      ...
      <div class="stats shadow-lg w-full my-2 bg-no-repeat bg-right-bottom" style="background-image: url(res/img/ic-selesai.svg);">
      ...
      <div class="stats shadow-lg w-full my-2 bg-no-repeat bg-right-bottom" style="background-image: url(res/img/ic-menunggu.svg);">
        <div class="flex justify-between items-center py-4 px-6">
          <div>
      ...
      <div class="stats shadow-lg w-full my-2 bg-no-repeat bg-right-bottom" style="background-image: url(res/img/ic-p.svg);">
        <div class="flex justify-between items-center py-4 px-6">
          <div>

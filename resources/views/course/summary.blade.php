  ...
  <body>
    <div class="flex">
      ...
      <div class="w-full h-full">
        ...
        <!-- Daftar Isi -->
        <div class="flex m-8 justify-start">
            <div class="flex flex-col items-center w-1/4 h-fit bg-base-100 rounded-2xl border-2 border-gray-200">
            ...
            <div class="flex flex-col mx-24 w-3/4 ">
                @php
                    $sub_count = 1;
                @endphp

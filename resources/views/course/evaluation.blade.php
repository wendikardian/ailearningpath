...
<div class="flex flex-col w-3/4 mx-24">
    ...
    <div  class="flex flex-col justify-center w-full bg-base-100 rounded-2xl border-2 p-8 mb-8 border-gray-200 text-gray-500">
        ...
        <div class="flex w-full">
            ...
            <div class="flex flex-col w-2/3 mr-4 border-2 rounded-2xl p-4">
            ...
            @else
            <form action="/eval-submit" method="POST" enctype="multipart/form-data" class="flex flex-col w-2/3 mr-4 border-2 rounded-2xl p-4">
                @csrf
            ...
            <div class="flex flex-col justify-between w-1/3 border-2 rounded-2xl p-4">
                <div>
